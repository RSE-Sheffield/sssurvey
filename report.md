...
![What is your job title?](charts/03_job.png){ width=15cm }
...
![Do you use research software?](charts/04_use.png){ width=15cm }
...
![How important is research software to your work?](charts/05_important.png){ width=15cm }
...
![Have you developed your own research software?](charts/06_developed.png){ width=15cm }
...
![How do you rate your software development expertise?](charts/07_rate_dev_exclude_no_response.png){ width=15cm }
...
![Do you feel that you have received sufficient training to develop reliable software?](charts/08_training_exclude_no_response.png){ width=15cm }
...
![Version control](charts/12_tech_vc_exclude_no_response.png){ width=15cm }

![Continuous integration](charts/13_tech_ci_exclude_no_response.png){ width=15cm }

![Unit testing](charts/14_tech_test_exclude_no_response.png){ width=15cm }
...
![How would you rate the university's current level of support for your software-development needs?](charts/15_support_exclude_no_response.png){ width=15cm }
...
![Hire a full-time software developer](charts/18_model_ft_exclude_no_response.png){ width=15cm }

![Recruit a developer (or fractional FTE equivalent of a developer) from a central University of Sheffield pool as needed](charts/19_model_rse_exclude_no_response.png){ width=15cm }

In practise, 15% of respondents research teams had hired a developer.

![Have you or someone in your group ever hired someone specifically to develop software?](charts/16_hired.png){ width=15cm }
...
![Have you used ShARC/Bessemer, the University's high-performance computing (HPC) system?](charts/11_hpc_exclude_no_response.png){ width=15cm }
...
![Would you be interested in the university helping you commercialise some of your research software?](charts/09_commercialise_exclude_no_response.png){ width=15cm }
...
![Do you feel that your research software is ready to be shared with a commercial partner?](charts/10_partner_exclude_no_response.png){ width=15cm }
